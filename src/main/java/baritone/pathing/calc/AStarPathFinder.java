...
public final class AStarPathFinder extends AbstractNodeCostSearch {
    ...
    protected Optional<IPath> calculate0(long primaryTimeout, long failureTimeout) {
        ...
        // Check time every 128 nodes instead of 64 — halves overhead from System.currentTimeMillis() on Windows
        int timeCheckInterval = 1 << 7;
        ...
        while (!openSet.isEmpty() && numEmptyChunk < pathingMaxChunkBorderFetch && !cancelRequested) {
            ...
            numNodes++;
            // Update volatile counters for real-time HUD display
            if ((numNodes & 0xFF) == 0) { // every 256 nodes
                this.nodesExplored = numNodes;
                this.movementsConsidered = numMovementsConsidered;
            }
