...
public final class BinaryHeapOpenSet implements IOpenSet {
    ...
    /**
     * The initial capacity of the heap (2^12 = 4096).
     * Larger initial capacity reduces costly Arrays.copyOf reallocations
     * during intensive pathfinding, especially for long paths.
     */
