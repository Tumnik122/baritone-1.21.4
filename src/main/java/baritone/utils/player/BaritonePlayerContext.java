...
public final class BaritonePlayerContext implements IPlayerContext {
    ...
    public HitResult objectMouseOver() {
        boolean sneaking = player().isCrouching() || (this.baritone != null && this.baritone.getInputOverrideHandler().isInputForcedDown(Input.SNEAK));
        return RayTraceUtils.rayTraceTowards(player(), playerRotations(), playerController().getBlockReachDistance(), sneaking);
    }
}
